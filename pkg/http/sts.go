...
func NewFromConfig(cfg *config.StaticConfig, provider *oidc.Provider) *SecurityTokenService {
	return &SecurityTokenService{
		Provider:                provider,
		ClientId:                cfg.StsClientId,
		ClientSecret:            cfg.StsClientSecret,
		ExternalAccountAudience: cfg.StsAudience,
		ExternalAccountScopes:   cfg.StsScopes,
	}
}
